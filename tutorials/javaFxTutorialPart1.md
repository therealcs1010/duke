...
Next, we create another Java class, `LauncherTest`, as an entry point to our application.
The `LauncherTest` class is reproduced below in its entirety.
...
public class LauncherTest {
    public static void main(String[] args) {
        Application.launch(DukeTest.class, args);
    }
}
```

Run `LauncherTest` and you should see something like this:
