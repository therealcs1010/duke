# JavaFX Tutorial Part 2 - Creating a GUI for DukeTest

In this tutorial, we will be creating a GUI for DukeTest from scratch based on the following mockup.

![Mockup for DukeTest](assets/DukeMockup.png)
...
![DukeTest's layout](assets/DukeSceneGraph.png) 
...
![DukeTest's raw layout](assets/RawLayout.png)
...
![DukeTest's Final layout](assets/FinalLayout.png)
